...
#define BytesPerSectorOFFSET (0x0B)
#define SectorsPerClusterOFFSET (0x0D) 
#define RsvdSectorCountOFFSET (0x0E)
#define NumberFATsOFFSET (0x10) 
#define RootEntryCountOFFSET (0x11) 
#define TotalSectors16OFFSET (0x13)
#define FATsize16OFFSET (0x16) 
#define TotalSectors32OFFSET (0x20) 
#define FATSize32OFFSET (0x24)
#define RootClusterOFFSET (0x2C)
